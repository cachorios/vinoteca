...
$catalogue = new MessageCatalogue('us', array (
  'login' => 
  array (
    'login.titulo' => 'Wellcome to Cabañas Wanfried',
    'login.footer' => 'By RBSoft',
    'login.mensaje' => 'Please, begin session for access.',
    'login.usuario' => 'User',
    'login.clave' => 'Password',
    'login.recordarme' => 'Reminder me',
    'login.perdio_clave' => 'Lost your password?',
    'login.btn_ingresar' => 'Login',
  ),
));
