...
class Productos extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        $prods = array(
            array('codigo' =>'01','cat' => 'Malbec', 'nombre' => 'Bonarda Lote Especial', 'desc' => 'Colomé elabora desde 1831 los afamados vinos de altura.
...
El silencio mágico, el cielo estrellado y un sol radiante e intenso llenan de energía y sentido místico la experiencia Colomé.', 'precio' => 15.25, 'iva' => 0.21 ),
            ...
            array('codigo' =>'02','cat' => 'Malbec','nombre' => 'Ciclos Tardio',  'desc' => 'El Valle de Cafayate, localizado a 1700 msnm, nos ofrece características incomparables para la elaboración de vinos únicos. Encuentra su máxima expresión en El Esteco que nos entrega una marcada tipicidad en sus vinos, con aromas y colores intensos que invitan a descubrir sus característicos sabores.', 'precio' => 112.00, 'iva' => 0.21 ),
            array('codigo' =>'03','cat' => 'Malbec','nombre' => 'Emma Zuccardi',  'desc' => 'Vista: Color profundo y matices purpuras violáceos. Aroma: Aromas típicos de frutas rojas y negras maduras -como frutillas, frambuesas, moras y cerezas negras. Sabor: En boca su entrada es voluminosa, con buen desarrollo, cuerpo intenso y sedoso, donde se destacan la suavidad de los taninos y su redondez.', 'precio' => 15.25, 'iva' => 0.21 ),
            array('codigo' =>'04','cat' => 'Sirah','nombre' => 'Encuentro 7 Vineyards',  'desc' => 'El savoir faire y lealtad al clasicismo francés en la elaboración artesanal de cada uno de los varietales, bivarietales, espumantes y dulce le han dado a esta marca un lugar de preferencia entre los consumidores que aprecian la complejidad aromática de un estilo aristocrático.', 'precio' => 85.63, 'iva' => 0.21 ),
            array('codigo' =>'05','cat' => 'Sirah','nombre' => 'Encuentro Cabernet',  'desc' => 'El savoir faire y lealtad al clasicismo francés en la elaboración artesanal de cada uno de los varietales, bivarietales, espumantes y dulce le han dado a esta marca un lugar de preferencia entre los consumidores que aprecian la complejidad aromática de un estilo aristocrático.', 'precio' => 523.20, 'iva' => 0.21 ),
