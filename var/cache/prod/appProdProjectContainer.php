...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('usuario.listener.doctrine'));
        $a->addEventListener(array(0 => 'postPersist'), $this->get('reposicion.listener.doctrine'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'postPersist', 2 => 'preUpdate', 3 => 'postUpdate'), $this->get('categoria.listener.doctrine'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('producto.listener.doctrine'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vinoteca', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_04145aa3945d904c6a53855396e3c7791de95531f65c1c76f46e3707982b20a0');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/prod.log'), 100, true, NULL);
    }
    ...
    {
        return $this->services['rbsoft.cartmanager'] = new \RBSoft\CartBundle\Model\CartManager($this->get('session'), $this->get('event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[3].'\\app/../web'), false);
