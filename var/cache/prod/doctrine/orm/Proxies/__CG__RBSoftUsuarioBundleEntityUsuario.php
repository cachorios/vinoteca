...
namespace Proxies\__CG__\RBSoft\UsuarioBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \RBSoft\UsuarioBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'RBSoft\\UsuarioBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'RBSoft\\UsuarioBundle\\Entity\\Usuario' . "\0" . 'telefono', '' . "\0" . 'RBSoft\\UsuarioBundle\\Entity\\Usuario' . "\0" . 'movil', '' . "\0" . 'RBSoft\\UsuarioBundle\\Entity\\Usuario' . "\0" . 'foto', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
