 ...
 */
class ProductoBonificacion extends \AppBundle\Entity\ProductoBonificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductoBonificacion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProductoBonificacion' . "\0" . 'unidad', '' . "\0" . 'AppBundle\\Entity\\ProductoBonificacion' . "\0" . 'valor', '' . "\0" . 'AppBundle\\Entity\\ProductoBonificacion' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\ProductoBonificacion' . "\0" . 'producto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductoBonificacion $proxy) {
