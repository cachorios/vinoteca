 ...
 */
class ContenidoDetalle extends \AppBundle\Entity\ContenidoDetalle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ContenidoDetalle' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ContenidoDetalle' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\ContenidoDetalle' . "\0" . 'imagen', '' . "\0" . 'AppBundle\\Entity\\ContenidoDetalle' . "\0" . 'link', '' . "\0" . 'AppBundle\\Entity\\ContenidoDetalle' . "\0" . 'contenido'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContenidoDetalle $proxy) {
    ...
    public function upload($nombre, $dir)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'upload', [$nombre, $dir]);

        return parent::upload($nombre, $dir);
    }
