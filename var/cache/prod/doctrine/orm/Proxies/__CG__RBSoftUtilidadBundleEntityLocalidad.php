 ...
 */
class Localidad extends \RBSoft\UtilidadBundle\Entity\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RBSoft\\UtilidadBundle\\Entity\\Localidad' . "\0" . 'id', '' . "\0" . 'RBSoft\\UtilidadBundle\\Entity\\Localidad' . "\0" . 'nombre', 'provincia'];
        }
