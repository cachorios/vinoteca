 ...
 */
class ProductoImagen extends \AppBundle\Entity\ProductoImagen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'primario', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'producto', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'delete', '' . "\0" . 'AppBundle\\Entity\\ProductoImagen' . "\0" . 'extension', 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductoImagen $proxy) {
    ...
    public function setPrimario($primario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrimario', [$primario]);

        return parent::setPrimario($primario);
    }
    ...
    public function getPrimario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrimario', []);

        return parent::getPrimario();
    }
